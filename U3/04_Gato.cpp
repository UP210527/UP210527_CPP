...
int main()
{
    ...
    int mode;
    cout << "Tic tac toe \n";
    cout << " 1) Do you want to play against the PC?  \n";
    cout << " 2) Do you want to play against a friend?  \n";
    ...
    if (gameover == true)
    {
        ...
        else
        {
            if (mode == 1)
            {
                cout << " PC WIN \n the fall of the great is the happiness of the mediocre, cheer up";
            }
            else
            {
                cout << "you are great pa" << endl;
    ...
    {
        cout << "this can't stay like this" << endl;
    }
    return 0;
}
...
int selectMove()
{
    ...
    do
    {
        cout << "In what position do you want your play?: ";
        cin >> jugada1;
